        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-8 order-1 lg:order-2">
            <article className="bg-cleanWhite rounded-lg border border-subtleGray px-4 sm:px-8 py-6 shadow-sm">
              ...
              {/* Article Title */}
              <h1 className="text-3xl md:text-4xl font-bold text-deepCharcoal mb-3 leading-tight">
                {news.title}
              </h1>

              {/* Article Subtitle */}
              {news.subtitle && (
                <p className="text-xl md:text-2xl text-slateBody/80 mb-3 font-medium">
                  {news.subtitle}
                </p>
              )}
              ...
              <div className="prose max-w-none prose-headings:text-deepCharcoal prose-p:text-slateBody prose-p:leading-relaxed prose-p:mb-4 prose-h4:text-xl prose-h4:font-bold prose-h4:mt-6 prose-h4:mb-3 prose-strong:text-deepCharcoal prose-ul:list-disc prose-ul:ml-6 prose-ol:list-decimal prose-ol:ml-6">
                <p className="text-lg text-slateBody leading-relaxed mb-4">
                  {news.summary}
                </p>
                <div 
              ...
              {/* Back Button */}
              <div className="mt-8 pt-6 border-t border-subtleGray flex justify-between items-center">
                <button
                  onClick={() => navigate(-1)}
