          ...
          <div className="flex-1 overflow-hidden relative h-full min-w-0">
            {loading ? (
              <div className="flex items-center justify-center h-full px-3 sm:px-6">
                <span className="text-cleanWhite text-xs sm:text-xs md:text-sm animate-pulse">लोड होत आहे...</span>
              </div>
              ...
              >
                {breakingNews.map((news, index) => (
                  ...
                  >
                    ...
                    >
                      {/* News Title */}
                      <span className="text-cleanWhite text-xs sm:text-xs md:text-base font-semibold line-clamp-1 group-hover:underline flex-1 min-w-0 truncate">
                        {news.title}
                      </span>
                      
                      {/* Category Badge - Hidden on very small screens */}
                      <span className="bg-cleanWhite/20 backdrop-blur-sm text-cleanWhite px-1.5 sm:px-2 py-0.5 rounded-full text-[10px] sm:text-[10px] md:text-sm font-medium whitespace-nowrap flex-shrink-0 border border-cleanWhite/30 hidden min-[375px]:inline-block">
                        {news.category}
                      </span>
                    </Link>
                  </div>
              ...
              <div className="flex items-center justify-center h-full px-3 sm:px-6">
                <span className="text-cleanWhite text-xs sm:text-xs md:text-sm">कोणतीही बातम्या उपलब्ध नाहीत</span>
              </div>
            )}
          </div>
