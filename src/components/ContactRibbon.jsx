    ...
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gradient-to-r from-newsRed via-red-600 to-newsRed shadow-lg border-t border-red-700/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-center py-2 md:py-2.5">
          ...
          <div className="flex items-center gap-2 md:gap-4 flex-nowrap justify-center overflow-x-auto">
            {/* Ads & News Contact Label */}
            <div className="flex items-center gap-2 bg-red-800/80 px-2.5 py-1 rounded border border-red-700/30">
              <span className="text-cleanWhite text-[11px] md:text-base font-semibold uppercase tracking-wide whitespace-nowrap">
            ...
            <a
              ...
              className="flex items-center gap-1.5 text-cleanWhite hover:text-yellow-200 transition-colors duration-200 group"
            >
              <FaEnvelope className="text-xs md:text-base group-hover:scale-105 transition-transform duration-200" />
              <span className="text-[11px] md:text-base font-medium whitespace-nowrap truncate max-w-[160px] md:max-w-none">
            ...
            <a
              ...
              className="flex items-center gap-1.5 bg-green-500/90 hover:bg-green-500 text-cleanWhite px-2.5 py-1 rounded-full text-[11px] md:text-base font-medium transition-all duration-200 shadow-sm hover:shadow cursor-pointer whitespace-nowrap"
            >
